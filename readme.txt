...
---------------------------
	...
	- Project on index.html file. It can be loaded locally.
	- Libraries used: Processingjs[1] for canvas animation, PureCss[2] for css framework
	- Tested on: Chrome
	...
	- .git folder provided for a history revision 
